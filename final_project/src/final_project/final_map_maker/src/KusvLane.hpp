...
public:
	...
	SKusvLanePoint(double dPtX_m, double dPtY_m):m_dPtX_m(dPtX_m), m_dPtY_m(dPtY_m){}	
	SKusvLanePoint(const SKusvLanePoint& other):m_dPtX_m(other.m_dPtX_m), m_dPtY_m(other.m_dPtY_m){}		
	~SKusvLanePoint(){}
};
...
public:	
	...
	SKusvLane(const SKusvLane& other):m_nLaneID(other.m_nLaneID), m_vecKusvLanePoint(other.m_vecKusvLanePoint){}		
	~SKusvLane(){}
};
